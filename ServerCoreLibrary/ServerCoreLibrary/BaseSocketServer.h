...
class BaseSocketServer : public IocpObject {
 public:
  BaseSocketServer(int32 maxSessionCount, NetAddress netAddress)
      : _maxSessionCount(maxSessionCount), _netAddress(netAddress) {
 ...
 protected:
  ...
  virtual void HandleIocpEvent(class IocpEvent* iocpEvent,
                               int32 numOfBytes = 0) sealed;

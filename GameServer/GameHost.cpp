...
GameHost::GameHost(sptr<ChampDataFactory> p_champDataFactory, int paramMatchId, vector<int> paramVecPlayerId)
    : champDataFactory(p_champDataFactory), matchId(paramMatchId), vecPlayerId(paramVecPlayerId)
{
}
...
bool GameHost::EnterClient(sptr<ClientSession> client)
{
    ...
    inGamePlayer->playerId = playerId;
